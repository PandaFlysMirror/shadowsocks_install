...
#   Author: Teddysun <admin@haobaobattery.cn>                             #
#   Thanks: @breakwa11 <https://haobaobattery.cn>            #
...
echo "# Intro: https://haobaobattery.cn                      #"
echo "# Author:  <admin@haobaobattery.cn>                         #"
...
libsodium_url="https://raw.githubusercontent.com/miaocloud/libsodium/master/down2/libsodium-1.0.16.tar.gz"
...
download_files(){
    ...
    if check_sys packageManager yum; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocksR -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download ShadowsocksR chkconfig file!"
            exit 1
        fi
    elif check_sys packageManager apt; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocksR-debian -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download ShadowsocksR chkconfig file!"
            exit 1
        fi
    fi
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo
        echo "Welcome to visit:https://haobaobattery.cn"
        echo "Enjoy it!"
        echo
    else
        echo "ShadowsocksR install failed, please Email to Teddysun <admin@haobaobattery.cn> and contact"
        install_cleanup
        exit 1
    fi
}
