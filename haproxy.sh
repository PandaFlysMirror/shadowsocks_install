...
#
# Intro:  https://admin@haobaobattery.cn
#
...
echo "# Intro: https://admin@haobaobattery.cn                     #"
...
pre_install(){
    ...
    read -p "(Default port: 2018):" haproxyport
    [ -z "${haproxyport}" ] && haproxyport="2018"
...
install(){
    ...
    echo
    echo "Welcome to visit: https://admin@haobaobattery.cn"
    echo "Enjoy it."
    echo
}
