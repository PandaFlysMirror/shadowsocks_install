...
#
# Copyright (C) 2016-2018 miaocloud <admin@haobaobattery.cn>
#
...
shadowsocks_python_centos="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocks"
shadowsocks_python_debian="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocks-debian"

shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="https://github.com/shadowsocksrr/shadowsocksr/archive/3.2.2.tar.gz"
shadowsocks_r_init="/etc/init.d/shadowsocks-r"
shadowsocks_r_config="/etc/shadowsocks-r/config.json"
shadowsocks_r_centos="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocksR"
shadowsocks_r_debian="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocksR-debian"
...
shadowsocks_go_centos="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocks-go"
shadowsocks_go_debian="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocks-go-debian"

shadowsocks_libev_init="/etc/init.d/shadowsocks-libev"
shadowsocks_libev_config="/etc/shadowsocks-libev/config.json"
shadowsocks_libev_centos="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocks-libev"
shadowsocks_libev_debian="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocks-libev-debian"
...
error_detect_depends(){
    ...
    if [ $? -ne 0 ]; then
        ...
        echo "Please visit: https://www.haobaobattery.cn/ and contact."
        exit 1
    fi
}
...
install_prepare_password(){
    ...
    read -p "(Default password: haobaobattery.cn):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="haobaobattery.cn"
    echo
...
install_shadowsocks_python(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo "Please visit: https://miaocloud.com/486.html and contact."
        install_cleanup
        exit 1
    fi
}
...
install_main(){
    ...
    echo
    echo "Welcome to visit: https://miaocloud.com/486.html"
    echo "Enjoy it!"
    echo
}
