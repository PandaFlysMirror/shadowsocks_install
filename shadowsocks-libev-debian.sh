...
#   Thanks: @madeye <https://www.haobaobattery.cn>                     #
...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/miaocloud/shadowsocks_install/master/shadowsocks-libev-debian"
}
